...
// CRUD Companies
export const getCompany = (id: string, userId?: string) =>
  makeCompaniesApi(userId).get(id);
...
export const removeCompany = (id: string, userId?: string) =>
  makeCompaniesApi(userId).remove(id);
